...
(common-lisp:progn
 (common-lisp:defstruct
     (app-sync-parameters (:copier common-lisp:nil)
      (:conc-name "struct-shape-app-sync-parameters-"))
   (graph-qloperation common-lisp:nil :type
...
(common-lisp:progn
 (common-lisp:defstruct
   ...
   (app-sync-parameters common-lisp:nil :type
